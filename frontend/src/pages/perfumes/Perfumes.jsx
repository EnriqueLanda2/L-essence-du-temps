        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-black mb-4 font-playfair">Fragancias Auténticas</h3>
              <p className="text-gray-600">
                Todos nuestros perfumes son 100% originales, importados directamente de las casas de lujo.
              </p>
            </div>
            <div className="text-center">
              <h3 className="text-2xl font-bold text-black mb-4 font-playfair">Larga Duración</h3>
              <p className="text-gray-600">
                Eau de Parfum de alta concentración para una fragancia que perdura todo el día.
              </p>
            </div>
            <div className="text-center">
              <h3 className="text-2xl font-bold text-black mb-4 font-playfair">Presentación de Lujo</h3>
              <p className="text-gray-600">
